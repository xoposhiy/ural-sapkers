...
public final class Loader
{
    private class OClassLoader extends ClassLoader
    {
            ...
            throws ClassNotFoundException
        {
            ...
            Exception exception;
            exception;
            throw new ClassNotFoundException((new StringBuilder()).append("Cannot load class ").append(s).toString(), exception);
        ...
        private byte[] load(String s, String as[])
            throws Exception
        {
            InputStream inputstream = loader/Loader.getResourceAsStream(s);
            if(inputstream == null)
            {
